...
public class OpSplatMixin {
    @WrapOperation(at = @At(value = "INVOKE", target = "Lat/petrak/hexcasting/api/casting/OperatorUtils;getList(Ljava/util/List;II)Lat/petrak/hexcasting/api/utils/TreeList;"), method = "execute")
    TreeList<Iota> redirectList(List<? extends Iota> stack, int it, int x, Operation<TreeList<Iota>> original) {
